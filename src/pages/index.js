	...
	return (
		<main className="h-screen">
				...
				<div className="flex flex-col gap-12">
					...
					<div className="flex justify-between">
						<div className="flex flex-col gap-8 items-center w-[300px]">
							...
							<div className="text-[18px]  text-center">We have 24/7 contact support so you can contact us whenever you want and we will respond it.</div>
						</div>
						<div className="flex flex-col gap-8 items-center w-[300px]">
							<div>
								<AiFillLock size={30} />
							...
							<div className="text-[18px]  text-center">We make sure your data is safe in our database and we will encrypt any data you submitted to us.</div>
						</div>
						<div className="flex flex-col gap-8 items-center w-[300px]">
							<div>
							...
							<div className="text-[18px]  text-center">Zwallet is 100% totally free to use it’s now available on Google Play Store and App Store.</div>
						</div>
					</div>
				</div>
			</div>
				...
				<div className=" flex-1 flex items-center ">
					<div className="flex flex-col gap-12 ">
						...
						<div className="font-bold text-[18px] bg-white rounded-xl shadow-xl px-2 py-5 ">
							1.&nbsp; &nbsp; Small Fee <p className="font-normal">We only charge 5% of every success transaction done in FazzPay app.</p>
						</div>
						<div className="font-bold text-[18px] bg-white rounded-xl shadow-xl px-2 py-5  ">
							2.&nbsp; &nbsp; Data Secured <p className="font-normal">All your data is secured properly in our system and it’s encrypted.</p>
						</div>
						<div className="font-bold text-[18px] bg-white rounded-xl shadow-xl px-2 py-5  ">
							3.&nbsp; &nbsp; User Friendly <p className="font-normal">FazzPay come up with modern and sleek design and not complicated.</p>
						</div>
					</div>
				</div>
			</div>
			<div className="flex flex-col items-center w-full pt-[150px] pb-[0px] gap-8 ">
				...
				<div className="max-w-[567px] text-lg text-center">We have some great features from the application and it’s totally free to use by all users around the world.</div>
				<div className="flex min-w-[988px] py-10">
					<div className="flex flex-col items-center rounded-2xl w-full h-[496px] text-center py-[60px]">
						...
						<div className="text-lg max-w-[869px] pt-11">
							“This is the most outstanding app that I’ve ever try in my live, this app is such an amazing masterpiece and it’s suitable for you who is bussy with their bussiness and must transfer money to another person aut
							there. Just try this app and see the power!”
						</div>
					</div>
				</div>
			</div>
			<footer className="bg-[#2FA9A2] px-[100px] py-[80px] ">
				<div className="flex flex-col gap-8 ">
					<Image src={logo} className="w-[125px] h-[40px]" alt="picture_logo" />

					<div className="max-w-[285px] text-[18px] ">Simplify financial needs and saving much time in banking needs with one single app.</div>
